...
<body>
    ...
    <div class="content-wrapper">
        <form class="content" action="themmonhoc.htm" method="post">
            <div class="form">

                <div class="right-form">
                    <div class="input1-right">
                        <label for="idMh">Mã Môn Học</label><br>
                        <input type="text" class="idMh" id="idMh" name="idMh" required>
                    </div>
                    <div class="input2-right">
                        <label for="tenMh">Môn Học</label><br>
                        <input type="text" class="tenMh" id="tenMh" name="tenMh" required>
                    </div>
                   <div class="wrapper1">
                        <div class="input3-right">
                            <label for="stc">Số tín chỉ</label><br>
                            <input type="number" class="stc" id="stc" name="stc" required>
                        </div>
                        <div class="input4-right">
                            <label for="stchp">Số tín chỉ học phần</label><br>
                            <input type="number" class="stchp" id="stchp" name="stchp" required>
                        </div>
                   </div>
                </div>
                ...
                <div class="left-form"> 
                    <div class="wrapper1">
                        <div class="input1-left">
                            <label for="%dcc">%Điểm chuyên cần</label><br>
                            <input type="number" class="%dcc" id="%dcc" name="%dcc" value="10" required>
                        </div>
                        <div class="input2-left">
                            <label for="%dse">%Điểm tiểu luận(Se)</label><br>
                            <input type="number" class="%dse" id="%dse" name="%dse" required>
                        </div>
                    </div>
                    <div class="wrapper2">
                        <div class="input1-left">
                            <label for="%dkt">%Điểm kiểm tra</label><br>
                            <input type="number" class="%dkt" id="%dkt" name="%dkt" required>
                        </div>
                        <div class="input2-left">
                            <label for="%dth">%Điểm thực hành</label><br>
                            <input type="number" class="%dth" id="%dth" name="%dth" required>
                        </div>
                    </div>
                    <div class="wrapper3">
                        <label for="%dt">%Điểm thi</label><br>
                        <input type="number" class="%dt" id="%dt" name="%dt" required>
                    </div>
                </div>
            </div><br>

           <div class="submit-btn">
                <input type="submit" class="submit" value="Thêm Môn Học">
           </div>
        </form> 
    </div>
    </div>
