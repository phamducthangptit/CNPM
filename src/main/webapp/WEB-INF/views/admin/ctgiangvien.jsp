...
<body>
 	<%@include file="header_admin.jsp"%>
			<div class="container mt-4">
				<form action="chinhsuagiangvien.htm" method="post">
					<div class="row justify-content-center">
						<div class="col-sm-6">
							<div class="mb-3">
								<label for="maGV" class="form-label">Mã giảng viên</label> <input
									type="text" class="form-control" name="maGV"
									 value="${teacher.maGV}" readonly="readonly">
							</div>
							<div class="mb-3">
						...
						<button type="submit" class="btn btn-success" style="width: 200px; margin-left: 5px" 
						name="deleteTeacher" value="DeleteTeacher">Xóa giảng viên</button>
					</div>
				</form>
			</div>
</body>
